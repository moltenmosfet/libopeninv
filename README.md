...
`fixes` is the integration branch, created off the pinned baseline commit 78e3f72. Fix branches (`fix/T<nn>-…`) merge into it.

Most fixes are staged for upstream as a PR series. Per-change notes: the superproject's [FORK_NOTES.md](https://github.com/moltenmosfet/stm32-sine/blob/fixes/FORK_NOTES.md).
